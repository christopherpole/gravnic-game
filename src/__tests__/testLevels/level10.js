import { MOVE_UP, MOVE_LEFT, MOVE_RIGHT, ENTITIES, levelIsComplete, makeMoves } from '../../index';
    ...
    const gameState = [
      ...
      [
        ...
        { staticEntity: { id: 18, entityId: ENTITIES.FLOOR }, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK, color: '#ff0000', id: 19 },
        },
      ],
      [
        ...
        { staticEntity: { id: 26, entityId: ENTITIES.BLACK_HOLE }, movableEntity: null },
        { staticEntity: null, movableEntity: null },
      ],
      [
        {
          staticEntity: { id: 28, entityId: ENTITIES.FLOOR },
          movableEntity: { entityId: ENTITIES.BLOCK, color: '#ff0000', id: 27 },
        },
        ...
        { staticEntity: { id: 30, entityId: ENTITIES.FLOOR }, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK, color: '#ff0000', id: 31 },
        },
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
      ...
      [
        { staticEntity: null, movableEntity: null },
        { staticEntity: { id: 33, entityId: ENTITIES.BLACK_HOLE }, movableEntity: null },
      ...
      [
        ...
        { staticEntity: null, movableEntity: null },
        {
          staticEntity: { id: 36, entityId: ENTITIES.FLOOR },
          movableEntity: { entityId: ENTITIES.BLOCK, color: '#ff0000', id: 35 },
        },
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
