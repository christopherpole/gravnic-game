    ...
    const gameState = [
      [
        { staticEntity: { id: 1, entityId: ENTITIES.BLACK_HOLE.id }, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#008000', id: 2 },
        },
        ...
        { staticEntity: { id: 6, entityId: ENTITIES.BLACK_HOLE.id }, movableEntity: null },
      ],
      [
        {
        ...
        { staticEntity: { id: 12, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#800080', id: 13 },
        },
      ],
      [
        { staticEntity: null, movableEntity: null },
        { staticEntity: { id: 15, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.GLASS.id, id: 16 },
        },
        {
          staticEntity: { id: 19, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.GLASS.id, id: 18 },
        },
      ...
      [
        ...
        { staticEntity: { id: 21, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.GLASS.id, id: 22 },
        },
        {
          staticEntity: { id: 25, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.GLASS.id, id: 24 },
        },
      ...
      [
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#FF8C00', id: 27 },
        },
        ...
        {
          staticEntity: { id: 34, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#0000FF', id: 33 },
        },
      ],
      [
        { staticEntity: { id: 35, entityId: ENTITIES.BLACK_HOLE.id }, movableEntity: null },
        {
          staticEntity: { id: 37, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#0000FF', id: 36 },
        },
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
        {
          staticEntity: { id: 39, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#008000', id: 38 },
        },
        { staticEntity: { id: 40, entityId: ENTITIES.BLACK_HOLE.id }, movableEntity: null },
      ],
    ];
