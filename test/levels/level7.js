    ...
    const gameState = [
      [
        ...
        },
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#008000', id: 3 },
        },
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
      ],
      ...
      [
        { staticEntity: null, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.RAINBOW_BLOCK.id, id: 7 },
        },
        {
          staticEntity: { id: 10, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.GLASS.id, id: 9 },
        },
      ...
      [
        ...
        { staticEntity: null, movableEntity: null },
        {
          staticEntity: { id: 18, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#008000', id: 17 },
        },
      ],
    ];
