      ...
      [
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#00ff00', id: 1 },
        },
      ...
      [
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#0000ff', id: 16 },
        },
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
        { staticEntity: { id: 18, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#00ff00', id: 19 },
        },
      ],
      [
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
        {
          staticEntity: { id: 22, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#0000ff', id: 21 },
        },
