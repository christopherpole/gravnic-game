    ...
    const gameState = [
      ...
      [
        ...
        { staticEntity: null, movableEntity: null },
        {
          ...
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#0000FF', id: 7 },
        },
      ...
      [
        { staticEntity: null, movableEntity: null },
        {
          staticEntity: { id: 17, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#ff0000', id: 16 },
        },
      ...
      [
        {
          staticEntity: { id: 24, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.RAINBOW_BLOCK.id, id: 23 },
        },
        ...
        { staticEntity: { id: 27, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 28, entityId: ENTITIES.STICKY_SPOT.id }, movableEntity: null },
      ...
      [
        { staticEntity: null, movableEntity: null },
        { staticEntity: { id: 31, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 32, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 33, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 34, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 35, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 36, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: null, movableEntity: null },
      ],
      [
        { staticEntity: null, movableEntity: null },
        { staticEntity: null, movableEntity: null },
        {
          staticEntity: { id: 38, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.BLOCK.id, color: '#0000FF', id: 37 },
        },
        { staticEntity: { id: 39, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 40, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 41, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: { id: 42, entityId: ENTITIES.FLOOR.id }, movableEntity: null },
        { staticEntity: null, movableEntity: null },
      ],
      [
        { staticEntity: null, movableEntity: null },
        ...
        { staticEntity: null, movableEntity: null },
        {
          staticEntity: { id: 44, entityId: ENTITIES.FLOOR.id },
          movableEntity: { entityId: ENTITIES.GLASS.id, id: 43 },
        },
        { staticEntity: null, movableEntity: null },
      ],
    ];
